...
#      Write your line here: x = int(input('please input an integer'))
#
#   2. Write a line of code that would input an FLOAT from the console,
#      storing the float in a variable called 'x'.
#      Write your line here: x = float(input('please input a float'))
#
#   3. Write a line of code that would input an STRING from the console,
#      storing the string in a variable called 'x'.
#      Write your line here: x = input('please input a string')                                                                                                                                   s
#
#   4. What happens if you (the user) enter something OTHER than aS
